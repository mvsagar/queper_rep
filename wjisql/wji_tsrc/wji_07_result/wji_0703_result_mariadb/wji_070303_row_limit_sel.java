/**
 * Tests limiting of rows to be displayed using SELECT button in result frame.
 */
...
public class wji_070303_row_limit_sel {
    ...
    public static void main(String[] args) throws IOException, InterruptedException { 
        ...
        // 6. Set max row limit to to 2 and execute using select button.
        we = driver.findElement(By.name("max_row_limit"));
        we.clear(); // Clear contens before sending value.
        // Clearing results in one popup saying invalid number. Let us okayit.
        try {
            WebDriverWait wait = new WebDriverWait(driver, 30);
            wait.until(ExpectedConditions.alertIsPresent());
            Alert alert = driver.switchTo().alert();
            // Let us ignore te err or message.
        ...
        we.sendKeys("2");
        System.out.println("Max row limit set: " + we.getAttribute("value"));
        
        // 7. Execute statement again.
        we = driver.findElement(By.id("btn-select-0"));
        we.click();
        // Accept popup warning.
        try {
            WebDriverWait wait = new WebDriverWait(driver, 30);
            wait.until(ExpectedConditions.alertIsPresent());
            Alert alert = driver.switchTo().alert();
        ...
        // 8. Make sure number of returned rows is only 2.
        cols = driver.findElements(By.xpath("//*[@id='tbl-rs-0']/thead/tr/th"));
        System.out.println("No of html table columns: " + cols.size());
        rows = driver.findElements(By.xpath("//*[@id='tbl-rs-0']/tbody/tr/td[1]"));
        System.out.println("No of html table rows: " + rows.size());
