...
public class wji_040302_unsucc_conn_with_inv_prefix_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.sendKeys("xyz:postgresql://localhost/pgsqldb");
        // enter user id
        ...
        try {
            ...
            System.out.println();
            if (errMsg.contains("Connection to database URL 'xyz:postgresql://localhost/pgsqldb' failed")){
