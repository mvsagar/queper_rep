/**
 * Tests unsuccessful connection with invalid database name in url.
 */
...
public class wji_040304_unsucc_conn_with_inv_dbname_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.clear();
        // Pass invalid db name "xyz".
        we.sendKeys("jdbc:postgresql://localhost/xyzdb");
        // enter user id
        ...
        try {
            ...
            System.out.println();
            if (errMsg.contains("Connection to database URL 'jdbc:postgresql://localhost/xyzdb' failed")){
                System.out.println("Connect: Unsuccessful login with invalid database name in url test passed.");
            } else {
                System.out.println("Connect: Unsuccessful login with invalid database name in url test failed.");
            }
            System.out.flush();
            alert.accept();
        } catch (Exception e) {
            System.out.println("Error:Alert:" + e.getMessage());
            System.out.println("Connect: Unsuccessful login with invalid database name in url failed.");
        }            
