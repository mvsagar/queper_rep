/**
 * Tests unsuccessful connection with invalid host in url.
 */
...
public class wji_040303_unsucc_conn_with_inv_host_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.sendKeys("jdbc:postgresql://xyz/pgsqldb");
        // enter user id
        ...
        try {
            ...
            System.out.println();
            if (errMsg.contains("Connection to database URL 'jdbc:postgresql://xyz/pgsqldb' failed")){
                System.out.println("Connect: Unsuccessful login with invalid host in url test passed.");
            } else {
                System.out.println("Connect: Unsuccessful login with invalid host in url test failed.");
            }
            System.out.flush();
            alert.accept();
        } catch (Exception e) {
            System.out.println("Error:Alert:" + e.getMessage());
            System.out.println("Connect: Unsuccessful login with invalid host in url failed.");
        }            
