...
public class wji_040204_unsucc_conn_with_inv_dbname_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.sendKeys("jdbc:mariadb://localhost/xyzdb");
        // enter user id
        ...
        try {
            ...
            System.out.println();
            if (errMsg.contains("Connection to database URL 'jdbc:mariadb://localhost/xyzdb' failed")){
