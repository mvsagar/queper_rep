...
public class wji_040202_unsucc_conn_with_inv_prefix_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.sendKeys("xyz:mariadb://localhost/mariadb");
        // enter user id
        ...
        try {
            ...
            System.out.println();
            if (errMsg.contains("Connection to database URL 'xyz:mariadb://localhost/mariadb' failed")){
