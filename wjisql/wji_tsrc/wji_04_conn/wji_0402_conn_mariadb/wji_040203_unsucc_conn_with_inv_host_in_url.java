...
public class wji_040203_unsucc_conn_with_inv_host_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.sendKeys("jdbc:mariadb://xyz/mariadb");
        // enter user id
        ...
        try {
            ...
            System.out.println();
            if (errMsg.contains("Connection to database URL 'jdbc:mariadb://xyz/mariadb' failed")){
