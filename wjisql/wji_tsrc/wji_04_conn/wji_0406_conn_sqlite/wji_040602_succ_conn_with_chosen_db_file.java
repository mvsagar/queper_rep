/**
 * Tests successful connection with chosen database file.
 * 
 * NOTE: This test does not work currently.
 *  We do not know how to supply folder to OS file manager invoked
 *  by browser.
 */
...
public class wji_040602_succ_conn_with_chosen_db_file{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we = driver.findElement(By.name("db_folder"));
        we.sendKeys("/tmp");
        
        // select database file
        // **** NB: This does not work. We do not know how to supply
        // db folder to OS browse screen
        we = driver.findElement(By.name("db_file"));
        Select dbFileSelect = new Select(we);
        dbFileSelect.selectByVisibleText("sqlitedb");
