...
public class wji_040103_unsucc_conn_with_inv_host_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.sendKeys("jdbc:mysql://xyz/mysqldb");
        // enter user id
        ...
        try {
            ...
            System.out.println();
            if (errMsg.contains("Connection to database URL 'jdbc:mysql://xyz/mysqldb' failed")){
