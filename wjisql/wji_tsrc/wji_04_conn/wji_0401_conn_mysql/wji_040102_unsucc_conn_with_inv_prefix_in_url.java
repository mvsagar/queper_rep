...
public class wji_040102_unsucc_conn_with_inv_prefix_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.sendKeys("xyz:mysql://localhost:3307/mysqldb");
        // enter user id
        ...
        try {
            ...
            System.out.println();
            if (errMsg.contains("Connection to database URL 'xyz:mysql://localhost:3307/mysqldb' failed")){
