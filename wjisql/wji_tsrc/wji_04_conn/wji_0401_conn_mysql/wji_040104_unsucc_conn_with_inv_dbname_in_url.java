...
public class wji_040104_unsucc_conn_with_inv_dbname_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.clear();
        // Pass invalid host "xyz".
        we.sendKeys("jdbc:mysql://localhost:3307/xyzdb");
        // enter user id
        ...
        try {
            ...
            System.out.println();
            if (errMsg.contains("Connection to database URL 'jdbc:mysql://localhost:3307/xyzdb' failed")){
