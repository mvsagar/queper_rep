...
public class wji_040105_unsucc_conn_with_inv_userid_in_url{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try {
            ...
            if (errMsg.contains("Connection to database URL '" 
                ...
                +"' failed")){
                System.out.println("Connect: Unsuccessful login with invalid user id in url test passed.");
            } else {
                System.out.println("Connect: Unsuccessful login with invalid user id in url test failed.");
            }
            System.out.flush();
            alert.accept();
        } catch (Exception e) {
            System.out.println("Error:Alert:" + e.getMessage());
            System.out.println("Connect: Unsuccessful login with invalid user id in url failed.");
        }            
