/**
 * Tests Cancellation of Cancellation of Update operation.
 * This allows one to resume changing any values further before confirming.
 */
...
class wji_080218_cancel_update_cancel {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        */
        ...
        // This does not show new values probably because they did not reach server.
        System.out.println("\nRows after updating 3rd row on the screen...");
        printHtmlTable(driver, "tbl-rs-0"); 
        
        // 13. Click buttion 'Cancel' to cancel insert operation.
        button = driver.findElement(By.xpath("//input[@value='Cancel']"));
        button.click();
        
        // 14. Dismiss pop up to reverse cancellation.
        try {
        ...
        // 15. Make sure textarea field used for updating is still present on the screen so that 
        // user can modify fields before confirming.
        // This is the main thing to be tested.
        try {
            col = driver.findElement(By.xpath("//textarea[@name='vr3c2']")); 
            System.out.println("Found TEXTAREA field vr3c2 created for updating intact.");
        } catch (NoSuchElementException nsee) {
            System.out.println("Error: TEXTAREA field vr3c2 created for updating is missing.");
        }
