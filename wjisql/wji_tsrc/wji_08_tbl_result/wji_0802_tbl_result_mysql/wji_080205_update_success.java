...
public class wji_080205_update_success {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // 6. 3rd row Question marks before updating
        waitForWe = (new WebDriverWait(driver, 10))
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"tbl-rs-0\"]/tbody/tr[3]/td[9]")));
        col = driver.findElement(By.xpath("//*[@id=\"tbl-rs-0\"]/tbody/tr[3]/td[9]")); 
        System.out.println("qtn_marks before updating: " + col.getText());  
        
        // 7. Select row 3 for updating
        ...
        waitForWe = (new WebDriverWait(driver, 10))
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@name='vr3c7']")));
        
        // 9. Supply data in qtn_marks column
        col = driver.findElement(By.xpath("//input[@name='vr3c7']")); 
        ...
        // 11. Check qtn_marks column value
        Thread.sleep(1000);
        driver.switchTo().defaultContent();
        driver.switchTo().frame("rightdatafr");
                    
        col = driver.findElement(By.xpath("//*[@id=\"tbl-rs-0\"]/tbody/tr[3]/td[9]"));
        System.out.println("qtn_marks after updating: " + col.getText());
