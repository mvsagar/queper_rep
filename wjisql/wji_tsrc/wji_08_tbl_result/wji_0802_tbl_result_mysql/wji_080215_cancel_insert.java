/**
 * Tests Cancellation of Insert operation.
 */
...
class wji_080215_cancel_insert {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        */
        ...
        // 7. Rows before insertion.
        System.out.println("Rows before clicking Insert button...");
        printHtmlTable(driver, "tbl-rs-0");    
        
        // 8. Click buttion 'Insert'
        ...
        // 9. Supply data in the first empty row.
        ...
        // 10. Rows after data on the screen.
        System.out.println("\nRows after adding data on the screen...");
        printHtmlTable(driver, "tbl-rs-0"); 
        
        // 11. Click buttion 'Cancel' to cancel insert operation.
        button = driver.findElement(By.xpath("//input[@value='Cancel']"));
        button.click();
        
        // 12. Accept pop up to confirm cancellation.
        try {
        ...
        // 13. Wait for  reetrieving table data for display.
        Thread.sleep(2000);
        
        // 14. Wait for html result set table is displayed.
        waitForWe = (new WebDriverWait(driver, 10))
                .until(ExpectedConditions.presenceOfElementLocated(By.id("tbl-rs-0")));  
        
        // 15. Make sure rows are as before insert operation.
        System.out.println("\nRows after clicking Cancel button...");
        printHtmlTable(driver, "tbl-rs-0");
       
        System.out.flush();   
        
        // 16. Disconnection from the database
        driver.switchTo().defaultContent();
        driver.switchTo().frame("navifr");
