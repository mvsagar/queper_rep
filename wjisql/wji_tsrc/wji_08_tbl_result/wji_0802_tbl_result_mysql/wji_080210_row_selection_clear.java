...
class wji_080210_row_selection_clear {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // 6. Check rows before Clear-row-selection button is clicked.
        rows = driver.findElements(By.xpath("//*[@id=\"tbl-rs-0\"]/tbody/tr/td[1]"));
        System.out.println("No rows before deletion: " + rows.size());

        // 7. Select row 1 and 3 
        we = driver.findElement(By.xpath("//input[@name='vr1c0']"));
        we.click();       
        System.out.println("Selection status of row 1: " + we.isSelected());
        we = driver.findElement(By.xpath("//input[@name='vr3c0']"));
        we.click();       
        System.out.println("Selection status of row 3: " + we.isSelected());
        
        // 8. Click buttion 'Clear row selection' .
        button = driver.findElement(By.xpath("//input[@value='Clear row selection']"));
        button.click();
        
        // 9. Check clearing of section of rows 1 and 3 
        we = driver.findElement(By.xpath("//input[@name='vr1c0']"));
        System.out.println("Selection status of row 1 after clear: " + we.isSelected());
        we = driver.findElement(By.xpath("//input[@name='vr3c0']"));
        System.out.println("Selection status of row 3 after clear: " + we.isSelected());       
