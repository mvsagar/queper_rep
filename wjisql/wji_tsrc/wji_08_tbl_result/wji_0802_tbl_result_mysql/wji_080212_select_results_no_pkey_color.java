...
public class wji_080212_select_results_no_pkey_color {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // 7. Click on 'Data'  button
        driver.switchTo().defaultContent();
        driver.switchTo().frame("rightdatafr");
        button = driver.findElement(By.xpath("//input[@value='Select']"));
        button.click();
        ...
        // 8. Check primary key column color.
        Thread.sleep(1000);
        driver.switchTo().defaultContent();
        driver.switchTo().frame("rightdatafr");
