/**
 * Tests failure of deletion of data.
 */
...
class wji_080308_deletion_failure {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // 7. Click buttion 'Delete' to delete without selecting any row to delete.
        ...
        // 9. Check rows after deletion failure
        rows = driver.findElements(By.xpath("//*[@id=\"tbl-rs-0\"]/tbody/tr/td[1]"));
