/**
 * Tests Cancellation of Cancellation of Insert operation.
 */
...
class wji_080316_cancel_insert_cancel {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        */
        ...
        // 12. Dismiss pop up to reverse cancel operation.
        try {
        ...
        // 13. Make sure newly added row is present on the screen.
        System.out.println("\nRows after clicking Cancel button...");
        printHtmlTable(driver, "tbl-rs-0");
       
        System.out.flush();   
        
        // 14. Disconnection from the database
        driver.switchTo().defaultContent();
        driver.switchTo().frame("navifr");
