...
class wji_080321_back{
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        */
        ...
        // 7. Rows before back.
        System.out.println("Rows before clicking Back button...");
        printHtmlTable(driver, "tbl-rs-0");        
        
        // 8. Click buttion 'Delete'
        button = driver.findElement(By.xpath("//input[@value='Back']"));
        button.click();
        
        // 9.Wait for html result set table is re-displayed for table priperties.    
        Thread.sleep(3000);
        driver.switchTo().defaultContent();
        driver.switchTo().frame("rightdatafr");
        waitForWe = (new WebDriverWait(driver, 10))
                .until(ExpectedConditions.presenceOfElementLocated(By.id("tbl-dbtblcols")));
   
        // 10. Columns of table emp
        System.out.println("\nColumns of table emp...");
        printHtmlTable(driver, "tbl-dbtblcols"); 
