/**
 * Tests execution of multiple SQL statements.
 */
...
public class wji_060205_exec_multi_stmts {
    ...
    public static void main(String[] args) throws IOException, InterruptedException { 
        ...
        driver.switchTo().defaultContent();
        (new WebDriverWait(driver, 5)).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("rightdatafr"));
        frameSource = driver.getPageSource();
        //System.out.println("rightdatafr:\n" + frameSource);
        ...
        // Drop new tables that were created.
        driver.switchTo().defaultContent();
        driver.switchTo().frame("sqlstmtfr");
