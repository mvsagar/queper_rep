 ...
 *
 */
public class wji_050311_procfunc_prop {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // Postgresql 10 does not support procedures. Hence commented.
        /* 
        ...
        */
        // 5.3 Display properties of function func_4_2_in_out_inout_args   
        
        driver.switchTo().defaultContent();
        driver.switchTo().frame("leftdatafr");
        we = driver.findElement(By.linkText("func_4_2_in_out_inout_args"));
        we.click();
