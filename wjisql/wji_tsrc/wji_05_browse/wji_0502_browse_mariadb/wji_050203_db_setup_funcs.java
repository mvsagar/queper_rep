 ...
 *
 */
public class wji_050203_db_setup_funcs {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.sendKeys(System.getenv("WJI_TSRC_HOME") + "/wji_scripts/wji_20_basic_mariadb_funcs/tst_20_001_func_drop_uc.sql");
        Thread.sleep(2000);
        ...
        // 4.2. Execute function create script 1
        ...
        we = driver.findElement(By.id("script_files"));
        we.sendKeys(System.getenv("WJI_TSRC_HOME") + "/wji_scripts/wji_20_basic_mariadb_funcs/tst_20_002_func_create_1_1_compute_tax_uc.sql");
        we =  driver.findElement(By.id("user_sqlstmt"));
        waitedTime = 0;
        while (we.getAttribute("value").trim().isEmpty() && waitedTime <= 5) {
            we =  driver.findElement(By.id("user_sqlstmt"));
        ...
        driver.switchTo().frame("sqlstmtfr");
        we = driver.findElement(By.id("script_files"));
        we.sendKeys(System.getenv("WJI_TSRC_HOME") + "/wji_scripts/wji_20_basic_mariadb_funcs/tst_20_003_func_exec_uc.sql");
        we =  driver.findElement(By.id("user_sqlstmt"));
        waitedTime = 0;
        while (we.getAttribute("value").trim().isEmpty() && waitedTime <= 5) {
            we =  driver.findElement(By.id("user_sqlstmt"));
