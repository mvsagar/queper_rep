...
public class wji_050101_db_setup_tables {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        we.sendKeys(System.getenv("WJI_TSRC_HOME") + "/wji_scripts/wji_01_basic_mysql_tables/tst_01_001_tables_drop_uc.sql");
        Thread.sleep(2000);
        ...
        */
        ...
        we = driver.findElement(By.id("script_files"));
        we.sendKeys(System.getenv("WJI_TSRC_HOME") + "/wji_scripts/wji_01_basic_mysql_tables/tst_01_002_tables_create_uc.sql");
        we =  driver.findElement(By.id("user_sqlstmt"));
        waitedTime = 0;
        while (we.getAttribute("value").trim().isEmpty() && waitedTime <= 5) {
            we =  driver.findElement(By.id("user_sqlstmt"));
        ...
        */
        ...
        driver.switchTo().frame("sqlstmtfr");
        we = driver.findElement(By.id("script_files"));
        we.sendKeys(System.getenv("WJI_TSRC_HOME") + "/wji_scripts/wji_01_basic_mysql_tables/tst_01_003_tables_insert_uc.sql");
        we =  driver.findElement(By.id("user_sqlstmt"));
        waitedTime = 0;
        while (we.getAttribute("value").trim().isEmpty() && waitedTime <= 5) {
            we =  driver.findElement(By.id("user_sqlstmt"));
        ...
        */
        ...
        driver.switchTo().frame("rightdatafr");
        waitForWe = (new WebDriverWait(driver, 10))
                .until(ExpectedConditions.presenceOfElementLocated(By.id("text-stmt-16")));
