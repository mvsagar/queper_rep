/**
 * Tests fix for the bug W_B_20170728_76 - resultset rows are not as per order by clause, for int columns.
...
public class wji_110106_W_B_20170728_76_order_by_for_int {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // Then execute.
        we = driver.findElement(By.id("user_sqlstmt"));
        we.sendKeys("SELECT c1, c2 FROM tord1 ORDER BY c1;");               
        we =  driver.findElement(By.id("user_sqlstmt"));
        waitedTime = 0;
        while (we.getAttribute("value").trim().isEmpty() && waitedTime <= 5) {
            we =  driver.findElement(By.id("user_sqlstmt"));
