...
public class wji_0303_menuitem_login_home {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        frameSource = driver.getPageSource();
        if (frameSource.contains("JDBC Driver") 
                 &&  frameSource.contains("Database URL") 
                 &&  frameSource.contains("User ID") 
                 &&  frameSource.contains("Password") 
            ){
        ...
        if (frameSource.contains("wjISQL") 
            ...
            System.out.println("Login: Navigation frame test passed");
        } else {
            System.out.println("Login: Navigation frame test failed");
            System.out.println(frameSource);
        }
        ...
        if (frameSource.contains("#Tables: 0") 
            ...
            System.out.println("Login: Left data frame test passed");
        } else {
            System.out.println("Login: Left data frame test failed");
            System.out.println(frameSource);
        }
        ...
        if (frameSource.contains("SQL Statement(s)")
            ...
            System.out.println("Login: SQL Statements frame test passed");
        } else {
            System.out.println("Login: SQL Statements frame test failed");
            System.out.println(frameSource);
        }
        ...
        // Check for empty right data frame.
        driver.switchTo().defaultContent();
        driver.switchTo().frame("rightdatafr");
        frameSource = driver.getPageSource();
        ...
        if (weList.size() == 0) {
            ...
            System.out.println("Login: Right data frame test passed");
        } else {
            System.out.println("Login: Right data frame test failed");
            System.out.println(frameSource);
        }
        
        // 3. Click Home menu link and check results
        driver.switchTo().defaultContent();
        driver.switchTo().frame("navifr");
