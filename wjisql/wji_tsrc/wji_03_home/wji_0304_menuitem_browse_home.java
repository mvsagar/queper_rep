/**
 * Tests Home link click functionality from browse screen of wjISQL.
 */
...
public class wji_0304_menuitem_browse_home {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        if (frameSource.contains("#Tables: 0") 
            ...
            System.out.println("Browse: Left data frame test passed");
        } else {
            System.out.println("Browse: Left data frame test failed");
        ...
        if (weList.size() == 0) {
            ...
            System.out.println("Browse: Right data frame test passed");
        } else {
            System.out.println("Browse: Right data frame test failed");
            System.out.println(frameSource);
        }
