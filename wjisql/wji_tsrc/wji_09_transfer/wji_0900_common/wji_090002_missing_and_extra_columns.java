...
public class wji_090002_missing_and_extra_columns {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // 2. Create table emp with extra columns in destination database.
       ...
       (new WebDriverWait(driver, 5))
        ...
        // Create tables emp with some missing and some extra columns.
        we = driver.findElement(By.id("user_sqlstmt"));
        we.sendKeys("DROP TABLE IF EXISTS emp;"
            + "CREATE TABLE emp(eno INT NOT NULL PRIMARY KEY, ename VARCHAR(20), edob DATE, eexp INT DEFAULT 0);"
            );       
        ...
        // 5. Login into destdb as user destusr
        driver.switchTo().defaultContent();
        driver.switchTo().frame("datafr");
        driver.switchTo().frame("rightdatafr");
        ...
        // 6. Select table emp for data transfer.
        driver.switchTo().defaultContent();
        driver.switchTo().frame("datafr");
        driver.switchTo().frame("leftdatafr");
        driver.switchTo().frame("leftdatafr1");        
        // Assuming emp would be second row transfer checkbox field is the first one. So name is c11.
        we = driver.findElement(By.xpath("//*[@id='src-tbl-list']/tbody/tr/td[4]/input[@name='c11']"));
        we.click();
        ...
        we = driver.findElement(By.xpath("//input[@value='emp']"));
        we.click();
        driver.switchTo().defaultContent();
        driver.switchTo().frame("datafr");
        driver.switchTo().frame("rightdatafr");
        ...
        System.out.println("Data of destination table 'emp:'");
        printHtmlTable(driver, "tbl-rs-0"); 
        
        // 8. Check data transfer page.
        ...
        // 9. Disconnect from the databases
        driver.switchTo().defaultContent();
        driver.switchTo().frame("navifr");
        ...
        // 10. Drop dept and emp tables in source database.
        // Click Connect menu link 
        driver.switchTo().defaultContent();
        driver.switchTo().frame("navifr");
        we = driver.findElement(By.linkText("Connect"));
